...
public class NotificationController {
    ...
    @Autowired
    public NotificationController(EventService eventService, AtomFeedClient atomFeedClient) {
    ...
    public String processEvents(String feedUri, String processType) throws URISyntaxException {
        ...
        atomFeedClient.processEvents(new URI(feedUri), eventWorker);
    ...
    public String processFailedEvents(String feedUri, String processType) throws URISyntaxException {
        ...
        atomFeedClient.processFailedEvents(new URI(feedUri), eventWorker);
